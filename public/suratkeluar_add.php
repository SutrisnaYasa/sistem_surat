...
$thn = date('Y');
$query = mysqli_query($config, "SELECT LEFT(noSuratKeluar,'4') as noSurat FROM sip_suratkeluar where kodebidang = '$golonganUserLogin' ORDER BY LEFT(noSuratKeluar,'4')  DESC LIMIT 0,1");
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="box box-default">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="suratkeluar_save.php" method="POST" enctype="multipart/form-data">
            <div class="box-body">
              <div class="form-group">
                ...
                <div>
                  <table>
                    <tr>
                      <!-- <td><input type="text" title="Kode Klasifikasi" id="kodeklasifikasi" name="kodeklasifikasi"class="form-control" style="width:100px" value="<?//=$array_nosurat['kodesurat']?>" required > -->
                      <input type="text" id="noSurat" name="noSurat" onKeyUp="myon()" class="form-control" required>
                      </td>
                      <td> </td>
                      <!--/*  <td><input type="text" title="Kode Bidang" id="kodebidang" name="kodebidang"class="form-control" style="width:80px" required ></td>
                  <td> / </td>*/-->
                      <!-- <td><input type="text" title="No Urut" id="noSurat" name="noSurat" onKeyUp="myon()" class="form-control" value="<?//=$noBaru?>" style="width:80px" required ></td>
                  <td> / </td>
                  <td><input type="text" title="Tahun" id="tahun" name="tahun"class="form-control" style="width:80px" value="Bapenda" required ></td>-->
                    </tr>
                  </table>
                </div>
              </div>
              <div class="form-group">
                ...
                <input type="text" id="tujuan" name="tujuan" class="form-control" value="" required>
              </div>
              <!--<div class="form-group">
                <label>Jenis Surat</label>
                <input type="text" id="jenisSurat" name="jenisSurat" class="form-control" required>
              </div>-->
              <div class="form-group">
                <label>Jenis Surat</label>
      ...
      <div class="col-md-6">
        <div class="box box-default">
          ...
          <div class="box-body chat" id="chat-box">
            ...
            <!-- /.chat -->
            <div class="item">
              <table width="100%" class="table table-striped table-bordered table-hover " style="font-size:12px" id="dataTables-example1">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Tujuan Surat</th>
