          ...
          <form method="post" action="" style="margin-bottom: 10px;">
            ...
            <table id="example1" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                WHERE a.tujuandivisi = '$kodeBidangUsername' $filterTanggal AND e.nosurat IS Null AND d.abaikanSurat = '1' GROUP BY d.nosurat ORDER BY tglInput DESC");
