...
<?php 
  ...
  $query_user=mysqli_query($config, "SELECT * FROM sip_user WHERE nip='$nip'");
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <label>NIK</label>
                      ...
                      <input type="text" class="form-control" id="nip" name="nip" readonly="readonly" value="<?php echo $nip; ?>">
