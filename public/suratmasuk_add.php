      ...
      <div class="col-xs-6">
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Form Tambah Surat Masuk.</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="suratmasuk_save.php" method="POST" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="Date" id="tglSurat" name="tglSurat" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input id="fileSurat" class="form-control" name="fileSurat" type="file" required>
              </div>
            </div>
            ...
            <form role="form" action="disposisi_save.php" method="POST" id="form-actionx" enctype="multipart/form-data">
              <div class="input-group my-colorpicker2">
                ...
                <div class="input-group-addon">
                  <div style="display:none" id="carix" data-toggle="modal" data-target="#myModal"><i class="fa fa-search"> Cari</i></div>
                </div>
