          ...
          <div class="box-body">
            <table id="example1" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                if ($kodeBidangUsername == '1' or $kodeBidangUsername == '2' or $kodeBidangUsername == '3') {
                  $and = " where (a.pengirim='$kodeBidang' or kodeBidang='$kodeBidang')";
                } else {
                  $and = " where a.kodeBidang='$kodeBidang'";
                }
                $query_suratmasuk = mysqli_query($config, "SELECT a.*,b.perihal,b.asalSurat,b.jenisSurat FROM sip_disposisisurat a inner join sip_suratmasuk b on a.noSurat=b.noSurat " . $and . $where);
                //echo "SELECT a.*,b.prihal,b.asalSurat,b.jenisSurat FROM sip_disposisisurat a inner join sip_suratmasuk b on a.noSurat=b.noSurat ".$and.$where;
                while ($array_suratmasuk = mysqli_fetch_array($query_suratmasuk)) {
                  $idSurat = $array_suratmasuk['kodeDisposisi'];
