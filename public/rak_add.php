...
<?php include"../template/header.php"; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-database"></i> TAMBAH DATA RAK
      </h1>
    </section>
        ...
        <div class="col-md-6">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Form Tambah Data Rak.</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="rak_save.php" method="POST" enctype="multipart/form-data">
              <div class="box-body">
