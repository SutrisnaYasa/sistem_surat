          ...
          <form method="post" action="" style="margin-bottom: 10px;">
            ...
            <table id="example1" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                LEFT JOIN sip_disposisisurat d ON c.nosurat = d.nosurat          
                WHERE a.tujuandivisi = '$kodeBidangUsername' $filterTanggal AND d.nosurat IS Null GROUP BY c.noSurat");
