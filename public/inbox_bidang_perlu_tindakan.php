...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      DAFTAR INBOX PERLU TINDAK LANJUT
    </h1>
  </section>
          ...
          <form method="post" action="" style="margin-bottom: 10px;">
            ...
            <table id="example1" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                WHERE (c.kodebidang='$kodeBidangUsername' or c.kodeBidang_2='$kodeBidangUsername' or c.kodeBidang_3='$kodeBidangUsername') $filterTanggal AND f.nosurat  IS NULL 
