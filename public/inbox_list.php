          ...
          <form method="post" action="" style="margin-bottom: 10px;">
            ...
            <table id="example1" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                $query_suratmasuk = mysqli_query($config, "SELECT c.fileSurat,c.idSurat,a.idtujuan,a.noSurat,a.tglInput,b.namaBidang, c.jenisSurat,c.perihal,c.asalSurat, d.status
                ...
                WHERE a.tujuandivisi = '$kodeBidangUsername' $filterTanggal GROUP BY c.noSurat");
