...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      DAFTAR INBOX SELESAI DITINDAK LANJUT
    </h1>
  </section>
          ...
          <form method="post" action="" style="margin-bottom: 10px;">
            ...
            <table id="example1" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                // $query_suratmasuk = mysqli_query($config, "SELECT b.idsurat,b.nosurat,jenissurat,perihal,asalSurat,e.namabidang  FROM sip_suratmasuk b 
                ...
                // JOIN sip_tindaklanjut f ON c.nosurat = f.nosurat
                // JOIN sip_report g ON c.nosurat = g.nosurat 
                // WHERE (c.kodebidang='$kodeBidangUsername' or c.kodeBidang_2='$kodeBidangUsername' or c.kodeBidang_3='$kodeBidangUsername') $filterTanggal AND f.nosurat IS NOT NULL AND g.nosurat IS NOT NULL GROUP BY f.nosurat
                // ");

                $query_suratmasuk = mysqli_query($config, "SELECT 
                    b.idsurat,
                    b.nosurat,
                    b.jenissurat,
                    b.perihal,
                    ...
                    INNER JOIN sip_bidang e ON c.userpengirim = e.kodebidang 
                    INNER JOIN sip_bidang d ON c.kodebidang = d.kodebidang
                    INNER JOIN sip_tindaklanjut f ON c.nosurat = f.nosurat
                    WHERE (c.kodebidang='$kodeBidangUsername' or 
                          c.kodeBidang_2='$kodeBidangUsername' or 
                          c.kodeBidang_3='$kodeBidangUsername') 
                    $filterTanggal                     
                    GROUP BY f.nosurat
                ");
